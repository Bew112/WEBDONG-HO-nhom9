...
Casual - Đồng hồ casual hàng ngày
...
✅ Checklist Hoàn Thành
 1. Dự án tạo thành công bằng Django/Flask
 2. Thiết kế giao diện chính (Home, Login, Dashboard, CRUD)
 3. Giao diện có bộ cục hợp lý, responsive
 4. Kết nối thành công với CSDL (SQLite)
 5. Tạo được ít nhất 2 bảng dữ liệu chính (Product, Category, Order, CartItem, OrderItem)
 6. Hiển thị dữ liệu mẫu (seed data) trên trang web
